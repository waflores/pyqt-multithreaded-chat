...
public class TellerClient10_bowman implements ActionListener
{
public static void main(String[] args)
 ...
 try {
     if (args.length == 0)
	    ...
	    new TellerClient10_bowman("localhost");
        }
     if (args.length == 1)
		 new TellerClient10_bowman(args[0]);
     if (args.length > 1)
        {
...
//=========================================================
public TellerClient10_bowman(String serverAddress) throws Exception // CONSTRUCTOR
    {
